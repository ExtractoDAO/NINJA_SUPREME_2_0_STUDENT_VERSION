...
N_Z_GRID_POINTS = 1000  # API performance optimization
...
# DATA LOADER (Student Edition with Hybrid SNe)
...
class NinjaDataVectorized:
    ...
    def load_all_data(self):
        ...
        # PANTHEON+ REAL BINNED (40 points)
        ...
        # PLANCK 2018 (truncated to 2D for speed)
...
class BaseModel:
    ...
    def __init__(self, H0, Om, data, w0=-1.0, wa=0.0, xi=0.0):
        ...
        self.Hz_interp = interpolate.interp1d(data.z_grid, self.hz_grid,
...
class DUT_Vectorized(BaseModel):
    ...
    def fs8_model(self, z):
        ...
        f_z = Om_z**0.52  # Slightly suppressed for DUT
...
# BEST-FIT PARAMETERS (from typical Student Edition run)
...
async def get_merkle_integrity():
    ...
    # Simple merkle root (concatenate all hashes and hash again)
...
# =============================================================================
# HTML VIEWER (Student Edition) - CONTINUAÇÃO
# =============================================================================
